...
class BroadcastMode extends $pb.ProtobufEnum {
  static const BroadcastMode BLOCK = BroadcastMode._(0, 'BLOCK');
  static const BroadcastMode SYNC = BroadcastMode._(1, 'SYNC');
  static const BroadcastMode ASYNC = BroadcastMode._(2, 'ASYNC');
