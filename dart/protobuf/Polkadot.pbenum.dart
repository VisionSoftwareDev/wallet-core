...
class Network extends $pb.ProtobufEnum {
  static const Network POLKADOT = Network._(0, 'POLKADOT');
  static const Network KUSAMA = Network._(2, 'KUSAMA');
...
class RewardDestination extends $pb.ProtobufEnum {
  static const RewardDestination STAKED = RewardDestination._(0, 'STAKED');
  static const RewardDestination STASH = RewardDestination._(1, 'STASH');
  static const RewardDestination CONTROLLER = RewardDestination._(2, 'CONTROLLER');
